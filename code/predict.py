...
def predict(chosen_model, img, classes=[], conf=0.0001):
    if classes:
...
# 读取图片
image = cv2.imread("Project/Active/Latency_attack/data/Img/0001.jpg")
result_img, _, labels = predict_and_detect(model, image, conf=0.001)
